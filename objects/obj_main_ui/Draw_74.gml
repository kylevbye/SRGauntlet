draw_rectangle_color(CONFIG.V_WIDTH*0.5, 0, CONFIG.V_WIDTH*0.5, 
CONFIG.V_HEIGHT, c_white, c_white, c_white, c_white, false);
...
draw_roundrect_color_ext(x, y, x+button_length, y+button_height, rad_x, rad_y, 
border_color, border_color, outline_flag);
// INNER
draw_roundrect_color_ext(x+border_length, y+border_length, x+button_length-border_length, y+button_height-border_length, 
