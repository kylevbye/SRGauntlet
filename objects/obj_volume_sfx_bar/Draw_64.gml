...
draw_healthbar(x-centered_offset_x, y, x+width-centered_offset_x, y+height, global.snd_volume*100, c_red, c_yellow, c_yellow, vol_direction, show_background, show_border);